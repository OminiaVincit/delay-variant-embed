...
%BIN%DiagramDistanceRunner_D64.exe --dim %DIM% --timehole %TIMEHOLE% --timetau %TIMETAU% --alltau %ALLTAU% --opttau %OPTTAU% -l %LEFT% -o %OUT% --thres %THRES% --method %METHOD% --taumax %TAUMAX%
